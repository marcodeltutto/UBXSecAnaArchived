...
// Fri Feb  2 10:01:34 2018 by ROOT version 6.06/06
// from TTree tree/
// found on file: ../files/mcc8.6_stopmu_test/ubxsec_output_mc_bnbnuecosmic_mcc8.6_stopmu_test17.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
 ...
 //UBXSecEvent     *ubxsec_event_split;
   ...
   TBranch        *b_slc_muoncandidate_maxscatteringangle;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../files/mcc8.6_stopmu_test/ubxsec_output_mc_bnbcosmic_bnbnuecosmic_merged_mcc8.6_stopmu_test18.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../files/mcc8.6_stopmu_test/ubxsec_output_mc_bnbcosmic_bnbnuecosmic_merged_mcc8.6_stopmu_test18.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../files/mcc8.6_stopmu_test/ubxsec_output_mc_bnbcosmic_bnbnuecosmic_merged_mcc8.6_stopmu_test18.root:/UBXSec");
...
void AnaTree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("slc_muoncandidate_maxscatteringangle", &slc_muoncandidate_maxscatteringangle, &b_slc_muoncandidate_maxscatteringangle);
